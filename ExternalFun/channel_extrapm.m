...
% =============================================================================@
% 
% Authors: Fran?ois Tadel, 2009-2012
%          Rey R. Ramirez, 2009
...
% USAGE:   WExtrap = GetTopoInterp(ChannelMat, iChan, Vertices, Faces, bfs_center, bfs_radius, F)
%          WExtrap = GetTopoInterp(ChannelMat, iChan, Vertices, Faces, bfs_center, bfs_radius)
function WExtrap = GetTopoInterp(ChannelMat, iChan, Vertices, Faces, bfs_center, bfs_radius, F) %#ok<DEFNU>
    % Parse inputs
    if (nargin < 7)
        F = [];
    end
